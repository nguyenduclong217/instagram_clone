          ...
          <SidebarMenu>
            ...
            <SidebarMenuItem>
              <SidebarMenuButton>
                ...
                >
                  <div className="flex w-8 h-8 items-center gap-1 cursor-pointer">
                    <img
                      src={`https://instagram.f8team.dev${user?.profilePicture}`}
                      alt=""
                ...
                {historyData?.length === 0 ? (
                  ...
                  historyData?.map((item) => (
                    <div
                      ...
                      className="mt-2 flex items-center gap-3 cursor-pointer w-[100%]"
                    >
                      <div className="flex items-center gap-3 w-full">
                        ...
                        <button
                          ...
                          className="text-sm text-gray-400 ml-auto mr-3 hover:text-red-500"
                        >
                          Xóa
                        </button>
                      </div>
